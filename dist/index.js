        ...
        children: Object.entries(BLOCK_TEMPLATES).map(function (_a) {
          ...
          return jsxRuntime.jsxs("div", {
            ...
            children: [jsxRuntime.jsx("div", {
              ...
              children: jsxRuntime.jsx(polaris.Icon, {
                source: getBlockIcon(type)
              })
            }), jsxRuntime.jsx(polaris.Text, {
              as: "span",
              variant: "bodyMd",
              fontWeight: "medium",
...
function BlockHeader(_a) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsxs("div", {
      ...
      children: [isSelected && jsxRuntime.jsx("div", {
        style: {
          fontSize: '12px',
          color: '#6b7280'
        },
...
function HeaderBlockSettings(_a) {
  ...
  return jsxRuntime.jsxs(polaris.BlockStack, {
    gap: "300",
    children: [jsxRuntime.jsx(polaris.Text, {
      as: "h4",
      variant: "headingXs",
      children: "Content"
    }), jsxRuntime.jsx(polaris.TextField, {
      label: "Header Text",
    ...
    }), jsxRuntime.jsx(polaris.Divider, {}), jsxRuntime.jsx(polaris.Text, {
      as: "h4",
      variant: "headingXs",
      children: "Styling"
    }), jsxRuntime.jsxs(polaris.Box, {
      children: [jsxRuntime.jsx(polaris.Text, {
        as: "p",
        variant: "bodyMd",
        children: "Background Color"
      }), jsxRuntime.jsx(polaris.Box, {
      ...
      children: [jsxRuntime.jsx(polaris.Box, {
        paddingBlockEnd: "100",
        children: jsxRuntime.jsxs(polaris.InlineStack, {
          align: "space-between",
          children: [jsxRuntime.jsx(polaris.Text, {
            as: "p",
            variant: "bodyMd",
            children: "Font Size"
          }), jsxRuntime.jsxs(polaris.Text, {
            as: "p",
            variant: "bodyMd",
            tone: "subdued",
      ...
      }), jsxRuntime.jsx(polaris.RangeSlider, {
        label: "",
...
function ProductBlockSettings(_a) {
  ...
  return jsxRuntime.jsxs(polaris.BlockStack, {
    ...
    }), jsxRuntime.jsx(polaris.Checkbox, {
...
function EmailBlockSettings(_a) {
  ...
  if (block.type === 'divider' || block.type === 'spacer') {
    ...
    return jsxRuntime.jsx(StyleOnlyComponent, {
      block: block,
      updateStyles: updateStyles
    });
  }
  var FullComponent = Component;
  return jsxRuntime.jsx(FullComponent, {
    block: block,
...
function BlockItem(_a) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsx(BlockHeader, {
      block: block,
      ...
      children: jsxRuntime.jsx(EmailBlockSettings, {
        block: block,
        onUpdate: onUpdate
      })
    })]
...
function useDragAndDrop(blocks, onMoveBlock) {
  var _a = React.useState({
    ...
    setDragState = _a[1];
  // Drag start handler
  var handleDragStart = React.useCallback(function (e, blockId) {
...
function BlockList(_a) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsx(AddBlockZone, {
      position: "top",
...
function VariablePanel(_a) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    }), showVariables && jsxRuntime.jsx("div", {
      style: {
        padding: '12px 16px',
        backgroundColor: '#ffffff',
        maxHeight: '200px',
        ...
        children: VARIABLES.map(function (item, index) {
          return jsxRuntime.jsxs("div", {
            ...
            children: [jsxRuntime.jsxs("div", {
              ...
              children: [jsxRuntime.jsx("code", {
              ...
              }), hoveredVariable === item.variable && jsxRuntime.jsxs("div", {
                style: {
                  position: 'absolute',
                  bottom: '100%',
                  left: '50%',
                ...
                children: [item.example, jsxRuntime.jsx("div", {
                  style: {
                    position: 'absolute',
                    top: '100%',
                    left: '50%',
...
function useBlockManager(blocks, onBlocksChange) {
  // Add new block
  var addBlock = React.useCallback(function (type, index) {
  ...
  // Remove block
  var removeBlock = React.useCallback(function (id) {
  ...
  // Update block
  var updateBlock = React.useCallback(function (id, updates) {
  ...
  var moveBlock = React.useCallback(function (fromIndex, toIndex) {
    var newBlocks = __spreadArray([], blocks, true);
...
function EmailEditorSidebar(_a) {
  ...
  var availableLanguages = React.useMemo(function () {
  ...
  var getAvailableLanguagesForSelection = React.useCallback(function () {
  ...
  var handleLanguageChange = React.useCallback(function (value) {
    setSelectedLanguage(value);
  }, []);
  var handleAddLanguage = React.useCallback(function () {
  ...
  var handleLanguageSelectChange = React.useCallback(function (value) {
    if (value === 'add_new') {
  ...
  var handleFormClose = React.useCallback(function () {
    setShowAddLanguageForm(false);
    setSelectedNewLanguage('');
  }, []);
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsxs("div", {
      ...
      children: [jsxRuntime.jsxs(polaris.Box, {
        padding: '400',
        width: "100%",
        children: [jsxRuntime.jsx(polaris.Box, {
          width: "100%",
          children: jsxRuntime.jsxs(polaris.InlineStack, {
            ...
            children: [jsxRuntime.jsx(polaris.Text, {
              ...
              children: jsxRuntime.jsx(polaris.Select, {
                label: "",
        ...
        }), showAddLanguageForm && jsxRuntime.jsxs("div", {
          style: {
            marginTop: '12px',
            padding: '12px',
            border: '1px solid #e1e3e5',
          ...
          children: [jsxRuntime.jsx("div", {
            ...
            children: [jsxRuntime.jsx(polaris.Button, {
              variant: "primary",
              onClick: handleAddLanguage,
              disabled: !selectedNewLanguage,
              size: "slim",
              children: "Add Language"
            }), jsxRuntime.jsx(polaris.Button, {
...
function HeaderBlockRenderer(_a) {
  ...
  return jsxRuntime.jsx("div", {
    ...
    children: content.showLogo && jsxRuntime.jsxs(jsxRuntime.Fragment, {
...
function ImageBlockRenderer(_a) {
  ...
  return jsxRuntime.jsx("div", {
    ...
    children: content.link ? jsxRuntime.jsx("a", {
...
function ProductBlockRenderer(_a) {
  ...
  return jsxRuntime.jsx("div", {
    ...
    children: jsxRuntime.jsxs("div", {
      ...
      children: [content.showImage && jsxRuntime.jsx("div", {
        style: {
          width: '80px',
          height: '80px',
        ...
        }), content.showPrice && jsxRuntime.jsx("div", {
          style: {
            fontSize: '20px',
            fontWeight: 'bold',
            color: '#007ace'
        ...
        }), content.showDescription && jsxRuntime.jsx("div", {
          style: {
            fontSize: '14px',
            color: '#6d7175',
            marginTop: '8px'
...
function FooterBlockRenderer(_a) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    }), content.unsubscribeText && jsxRuntime.jsx("div", {
      style: {
        fontSize: '12px',
        color: '#999999'
      },
    ...
    }), content.showSocial && jsxRuntime.jsx("div", {
      style: {
        marginTop: '16px'
      },
    ...
    children: [jsxRuntime.jsx("div", {
      ...
      children: blocks.map(function (block, index) {
        return jsxRuntime.jsx("div", {
          ...
          children: jsxRuntime.jsx(BlockComponent, {
            block: block,
...
function BlockComponent(_a) {
  ...
  switch (block.type) {
    case 'header':
      return jsxRuntime.jsx(HeaderBlockRenderer, {
        block: block,
        replaceVariables: replaceVariables
      });
    case 'text':
      return jsxRuntime.jsx(TextBlockRenderer, {
        block: block,
        replaceVariables: replaceVariables
      });
    case 'image':
      return jsxRuntime.jsx(ImageBlockRenderer, {
        block: block,
        replaceVariables: replaceVariables
      });
    case 'button':
      return jsxRuntime.jsx(ButtonBlockRenderer, {
        block: block,
        replaceVariables: replaceVariables
      });
    case 'product':
      return jsxRuntime.jsx(ProductBlockRenderer, {
        block: block,
        replaceVariables: replaceVariables
      });
    case 'footer':
      return jsxRuntime.jsx(FooterBlockRenderer, {
        block: block,
        replaceVariables: replaceVariables
      });
    case 'divider':
      return jsxRuntime.jsx(DividerBlockRenderer, {
        block: block
      });
    case 'spacer':
      return jsxRuntime.jsx(SpacerBlockRenderer, {
        block: block
      });
    default:
      return null;
...
function EmailPreviewPanel(_a) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsx("div", {
      ...
      children: blocks.length > 0 ? jsxRuntime.jsx("div", {
        style: {
          width: '100%',
          maxWidth: '600px',
          backgroundColor: '#ffffff',
        ...
        children: jsxRuntime.jsx(EmailBlockRenderer, {
          blocks: blocks,
          replaceVariables: replaceVariables,
          selectedBlockId: selectedBlockId
        })
...
function EmailEditorLayout(_a) {
  ...
  var handleTemplateChange = React.useCallback(function (template) {
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsx(EmailEditorSidebar, {
      templates: templates,
      ...
      showVariables: showVariables,
      setShowVariables: setShowVariables
    }), jsxRuntime.jsx(EmailPreviewPanel, {
      blocks: currentTemplate === null || currentTemplate === void 0 ? void 0 : currentTemplate.blocks,
      selectedBlockId: selectedBlockId,
      replaceVariables: replaceVariables
    })]
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsxs("div", {
      ...
      children: [jsxRuntime.jsx(polaris.Box, {
        ...
        children: jsxRuntime.jsxs(polaris.BlockStack, {
          gap: "300",
          align: "center",
          children: [jsxRuntime.jsx("div", {
            style: {
            ...
            children: jsxRuntime.jsx(SvgEmailIcon, {})
          }), jsxRuntime.jsxs(polaris.BlockStack, {
            gap: "100",
            align: "center",
            children: [jsxRuntime.jsx(polaris.Text, {
              as: "p",
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsxs("div", {
      ...
      children: [jsxRuntime.jsx(polaris.Box, {
        ...
        children: jsxRuntime.jsx(polaris.BlockStack, {
          gap: "200",
          ...
          children: jsxRuntime.jsx("div", {
            ...
            children: jsxRuntime.jsxs(polaris.BlockStack, {
              ...
              children: [jsxRuntime.jsx("div", {
                ...
                children: [jsxRuntime.jsx(polaris.SkeletonDisplayText, {
                  size: "small"
                }), jsxRuntime.jsx("div", {
                  style: {
                    marginTop: '8px'
                  },
                  children: jsxRuntime.jsx(polaris.SkeletonBodyText, {
                    lines: 3
                  })
                })]
              }), jsxRuntime.jsx("div", {
                ...
                children: jsxRuntime.jsxs(polaris.InlineStack, {
                  ...
                  children: [jsxRuntime.jsx("div", {
                    ...
                    children: jsxRuntime.jsxs(polaris.BlockStack, {
                      ...
                      }), jsxRuntime.jsx(polaris.SkeletonBodyText, {
                        lines: 2
                      }), jsxRuntime.jsx("div", {
                        style: {
                          height: '16px',
...
function useTemplateLoader() {
  ...
  var _d = React.useState(null),
    error = _d[0],
    setError = _d[1];
  var fetcher = react.useFetcher();
  // load template
  var loadTemplate = React.useCallback(function (templateName) {
    setLoading(true);
    setError(null);
  ...
  //save template
  var saveTemplate = React.useCallback(function (templateData) {
    setLoading(true);
    setError(null);
  ...
  // clear template
  var clearTemplate = React.useCallback(function () {
    setTemplate(null);
    setError(null);
    setLoading(false);
  }, []);
  // update templates manually
  var updateTemplates = React.useCallback(function (newTemplates) {
    setTemplates(newTemplates);
  }, []);
  // select tempalte
  var selectTemplate = React.useCallback(function (template) {
...
function EmailTemplateEditor(_a) {
  ...
  var _d = React.useState(propInitialBlocks || initialBlocks),
    blocks = _d[0],
    setBlocks = _d[1];
  ...
  var getModalContent = function getModalContent() {
    if (templateLoader.loading && !templateLoader.template) {
      return jsxRuntime.jsx(EmailEditorSkeleton, {
        showPreview: true
      });
    }
    if (!templateLoader.loading && !templateLoader.error && !templateLoader.template && isTemplateLoaded) {
      return jsxRuntime.jsx(EmailEditorEmptyState, {
        templateName: templateName,
        onCreateTemplate: handleCreateDefaultTemplate
      });
    }
    if (templateLoader.error) {
      return jsxRuntime.jsx(EmailEditorErrorState, {
        templateName: templateName || '',
        handleTryAgain: handleTryAgain
      });
    }
    return jsxRuntime.jsx(EmailEditorLayout, {
  ...
  return jsxRuntime.jsxs(appBridgeReact.Modal, {
    open: isOpen,
    variant: "max",
    onHide: onClose,
    children: [jsxRuntime.jsx(appBridgeReact.TitleBar, {
      title: getModalTitle(),
      children: titleBarActions.primaryAction && jsxRuntime.jsx("button", {
        variant: "primary",
...
exports.BLOCK_TEMPLATES = BLOCK_TEMPLATES;
exports.BlockList = BlockList;
exports.ButtonBlockRenderer = ButtonBlockRenderer;
exports.ButtonBlockSettings = ButtonBlockSettings;
exports.DEFAULT_TEMPLATES = DEFAULT_TEMPLATES;
exports.DividerBlockRenderer = DividerBlockRenderer;
exports.DividerBlockSettings = DividerBlockSettings;
exports.EmailBlockRenderer = EmailBlockRenderer;
exports.EmailBlockSettings = EmailBlockSettings;
exports.EmailEditorEmptyState = EmailEditorEmptyState;
exports.EmailEditorErrorState = EmailEditorErrorState;
exports.EmailEditorLayout = EmailEditorLayout;
exports.EmailEditorSidebar = EmailEditorSidebar;
exports.EmailPreviewPanel = EmailPreviewPanel;
exports.EmailTemplateEditor = EmailTemplateEditor;
exports.FooterBlockRenderer = FooterBlockRenderer;
exports.FooterBlockSettings = FooterBlockSettings;
exports.HeaderBlockRenderer = HeaderBlockRenderer;
exports.HeaderBlockSettings = HeaderBlockSettings;
exports.ImageBlockRenderer = ImageBlockRenderer;
exports.ImageBlockSettings = ImageBlockSettings;
exports.ProductBlockRenderer = ProductBlockRenderer;
exports.ProductBlockSettings = ProductBlockSettings;
exports.SAMPLE_DATA = SAMPLE_DATA;
exports.SpacerBlockRenderer = SpacerBlockRenderer;
exports.SpacerBlockSettings = SpacerBlockSettings;
exports.TEMPLATE_LIMITS = TEMPLATE_LIMITS;
exports.TEMPLATE_NAME = TEMPLATE_NAME;
exports.TextBlockRenderer = TextBlockRenderer;
exports.TextBlockSettings = TextBlockSettings;
exports.VARIABLES = VARIABLES;
exports.VariablePanel = VariablePanel;
exports.availableLanguages = availableLanguages;
exports.getSmsSegmentCount = getSmsSegmentCount;
exports.initialBlocks = initialBlocks;
exports.replaceVariablesWithSampleData = replaceVariablesWithSampleData;
exports.useBlockManager = useBlockManager;
exports.useDragAndDrop = useDragAndDrop;
exports.useTemplateLoader = useTemplateLoader;
exports.validateSmsTemplate = validateSmsTemplate;
exports.validateWebPushTemplate = validateWebPushTemplate;
